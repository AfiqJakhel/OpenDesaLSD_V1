            ...
            <div class="col-md-9">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <x-kembali-button judul="Kembali ke Daftar Data Produk" :url="'/lapak_admin/produk' . (request('id_pend') ? '?id_pend=' . request('id_pend') : '')"/>
                    </div>
                    <div class="box-body">
        ...
        $(document).ready(function() {
            Swal.fire({
                ...
                if (!result.isConfirmed) {
                    window.location.href = "{{ site_url('lapak_admin/produk') }}" + "{!! request('id_pend') ? '?id_pend=' . request('id_pend') : '' !!}";
                }
            });
        });
        @endif
