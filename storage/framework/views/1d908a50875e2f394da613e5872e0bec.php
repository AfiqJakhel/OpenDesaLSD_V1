    ...
    <div class="search">
        ...
        <div class="box-body">
            <div class="row" id="list-paket">
                <?php echo form_open(ci_route('plugin.pasang'), 'id="mainform" name="mainform"'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/plugin/paket_tersedia.blade.php ENDPATH**/ ?>