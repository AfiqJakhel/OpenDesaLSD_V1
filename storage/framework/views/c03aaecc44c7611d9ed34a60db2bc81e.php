<div class="modal fade in" id="impor-pengguna">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open(ci_route('grup.impor'), 'id="validasi" enctype="multipart/form-data"'); ?>
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/pengaturan/grup/impor.blade.php ENDPATH**/ ?>