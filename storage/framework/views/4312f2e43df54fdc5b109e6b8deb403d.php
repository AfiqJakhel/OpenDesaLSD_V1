<div class="row">
        ...
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right tgl_sekarang required" name="tgl_peristiwa" type="text"
                    value="<?php echo e($penduduk['tgl_peristiwa'] ? rev_tgl($penduduk['tgl_peristiwa']) : date('d-m-Y')); ?>">
            </div>
        </div>
    </div>
    <?php endif; ?>
        ...
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right tgl_sekarang required" name="tgl_lapor" type="text"
                    value="<?php echo e($penduduk['tgl_lapor'] ? rev_tgl($penduduk['tgl_lapor']) : date('d-m-Y')); ?>">
            </div>
        </div>
    </div>
    <?php endif; ?>
        ...
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm">
                ...
                <input id="nik" name="nik" class="form-control input-sm required nik" type="text"
                    placeholder="Nomor NIK" value="<?php echo e($penduduk['nik']); ?>" <?php if($cek_nik=='0' ): echo 'readonly'; endif; ?>></input>
            </div>
        </div>
    </div>
    <div class='col-sm-8'>
        <div class='form-group'>
            ...
            <input id="nama" name="nama" class="form-control input-sm required nama" maxlength="100" type="text"
                placeholder="Nama Lengkap" value="<?php echo e(strtoupper($penduduk['nama'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-12'>
        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="ktp_el" id="ktp_el" class="form-control input-sm wajib_identitas"
                                            ...
                                            <option value="<?php echo e($key); ?>" <?= (($jenis_peristiwa=='1' && $key==3) ||
                                                $penduduk['ktp_el']==$key) ? 'selected' : ''; ?>>
                                    ...
                                    <td width='25%'>
                                        <input id="tag_id_card" name="tag_id_card" class="form-control input-sm digits"
                                            ...
                                            value="<?php echo e($penduduk['tag_id_card']); ?>"></input>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <input id="tempat_cetak_ktp" name="tempat_cetak_ktp" class="form-control input-sm" maxlength="150"
                        ...
                        value="<?php echo e($penduduk['tempat_cetak_ktp']); ?>"></input>
                </div>
            </div>
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <div class="input-group input-group-sm date">
                        ...
                        <input class="form-control input-sm pull-right" id="tanggal_cetak_ktp" name="tanggal_cetak_ktp"
                            type="text"
                            value="<?php echo e($penduduk['tanggal_cetak_ktp'] ? date('d-m-Y', strtotime($penduduk['tanggal_cetak_ktp'])) : ''); ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <input id="no_kk_sebelumnya" name="no_kk_sebelumnya" class="form-control input-sm no_kk" maxlength="30"
                ...
                value="<?php echo e(strtoupper($penduduk['no_kk_sebelumnya'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select id="kk_level" class="form-control input-sm required select2" name="kk_level">
                ...
                <option value="<?php echo e($key); ?>" <?= ($penduduk['kk_level']==$key) ? 'selected' : ''; ?> <?= ($key==1 &&
                    $keluarga['status_dasar']=='2') ? 'disabled' : ''; ?>>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select class="form-control input-sm required" name="sex"
                ...
                <option value="1" <?= ($penduduk['id_sex']==\App\Enums\JenisKelaminEnum::LAKI_LAKI) ? 'selected' : ''; ?>>Laki-Laki
                </option>
                <option value="2" <?= ($penduduk['id_sex']==\App\Enums\JenisKelaminEnum::PEREMPUAN) ? 'selected' : ''; ?>>Perempuan
                </option>
            </select>
        </div>
    </div>
        ...
        <div class='col-sm-8'>
            <div class='form-group'>
                ...
                <textarea id="maksud_tujuan_kedatangan" name="maksud_tujuan_kedatangan" class="form-control input-sm"
                    style="resize: none"
                    placeholder="Maksud dan Tujuan Kedatangan"><?php echo e($penduduk['maksud_tujuan_kedatangan']); ?></textarea>
            </div>
        </div>
    </div>
    <div class='col-sm-12'>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <input id="akta_lahir" name="akta_lahir" class="form-control input-sm nomor_sk" type="text" maxlength="40"
                placeholder="Nomor Akta Kelahiran" value="<?php echo e($penduduk['akta_lahir']); ?>"></input>
        </div>
    </div>
    <div class='col-sm-8'>
        <div class='form-group'>
            ...
            <input id="tempatlahir" name="tempatlahir" class="form-control input-sm required" maxlength="100"
                type="text" placeholder="Tempat Lahir" value="<?php echo e(strtoupper($penduduk['tempatlahir'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right required" id="tgl_lahir" name="tanggallahir" type="text"
                    value="<?php echo e($penduduk['tanggallahir']); ?>">
            </div>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right" id="jammenit_1" name="waktu_lahir" type="text"
                    value="<?php echo e($penduduk['waktu_lahir']); ?>">
            </div>
        </div>
    </div>
    <div class='col-sm-4'>
            ...
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <input id="kelahiran_anak_ke" name="kelahiran_anak_ke" class="form-control input-sm number" min="1"
                        ...
                        value="<?php echo e($penduduk['kelahiran_anak_ke']); ?>"></input>
                </div>
            </div>
            <div class='col-sm-4'>
                <div class='form-group'>
            ...
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <input id="berat_lahir" name="berat_lahir" class="form-control input-sm number" maxlength="6"
                        ...
                        value="<?php echo e(strtoupper($penduduk['berat_lahir'])); ?>"></input>
                </div>
            </div>
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <input id="panjang_lahir" name="panjang_lahir" class="form-control input-sm number" maxlength="3"
                        ...
                        value="<?php echo e(strtoupper($penduduk['panjang_lahir'])); ?>"></input>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select class="form-control input-sm required" name="pendidikan_kk_id">
                ...
                <option value="<?php echo e($key); ?>" <?= ($penduduk['pendidikan_kk_id']==$key || ($jenis_peristiwa=='1' &&
                    $key==1)) ? 'selected' : ''; ?>><?php echo e(strtoupper($value)); ?>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select class="form-control input-sm" name="pendidikan_sedang_id">
                ...
                <option value="<?php echo e($key); ?>" <?= ($penduduk['pendidikan_sedang_id']==$key || ($jenis_peristiwa=='1'
                    && $key==18)) ? 'selected' : ''; ?>><?php echo e(strtoupper($value)); ?>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select class="form-control input-sm required" name="pekerjaan_id">
                ...
                <option value="<?php echo e($key); ?>" <?= ($penduduk['pekerjaan_id']==$key || ($jenis_peristiwa=='1' &&
                    $key=='1' )) ? 'selected' : ''; ?>><?php echo e(strtoupper($value)); ?>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <?php if($status_pantau): ?>
            <select class="form-control input-sm" data-placeholder="Pilih Adat" id="adat" name="adat">
                <?php if($penduduk): ?>
                <option value="<?php echo e($penduduk['adat'] ?? ''); ?>" selected><?php echo e($penduduk['adat'] ?? ''); ?></option>
                <?php endif; ?>
            </select>
            <?php else: ?>
            <select class="form-control input-sm select2-tags nama_adat" id="adat" name="adat">
                <option value="">Pilih Adat</option>
                <?php if($adat_penduduk): ?>
                <?php $__currentLoopData = $adat_penduduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?= ($penduduk['adat']==$key) ? 'selected' : ''; ?>><?php echo e($key); ?>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select class="form-control input-sm" data-placeholder="Pilih Suku/Etnis" id="suku" name="suku">
                <?php if($penduduk): ?>
                <option value="<?php echo e($penduduk['suku'] ?? ''); ?>" selected><?php echo e($penduduk['suku'] ?? ''); ?></option>
                <?php endif; ?>
            </select>
            <?php else: ?>
            <select class="form-control input-sm select2-tags nama_suku" id="suku" name="suku">
                ...
                <option value="<?php echo e($key); ?>" <?= ($penduduk['suku']==$key) ? 'selected' : ''; ?>><?php echo e($key); ?>
    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <select class="form-control input-sm" data-placeholder="Pilih Marga" id="marga" name="marga">
                <?php if($penduduk): ?>
                <option value="<?php echo e($penduduk['marga'] ?? ''); ?>" selected><?php echo e($penduduk['marga'] ?? ''); ?></option>
                <?php endif; ?>
            </select>
            <?php else: ?>
            <select class="form-control input-sm select2-tags nama_suku" id="marga" name="marga">
                <option value="">Pilih Marga</option>
                <?php if($marga_penduduk): ?>
                <?php $__currentLoopData = $marga_penduduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?= ($penduduk['marga']==$key) ? 'selected' : ''; ?>><?php echo e($key); ?>

                </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <optgroup label="----------"></optgroup>
                <?php endif; ?>
                <?php $__currentLoopData = $marga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?= ($penduduk['marga']==$key) ? 'selected' : ''; ?>><?php echo e($key); ?>
            ...
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <select class="form-control input-sm required" id="warganegara_id" name="warganegara_id"
                        ...
                        <option value="<?php echo e($key); ?>" <?= ($penduduk['warganegara_id']==$key) ? 'selected' : ''; ?>>
            ...
            <div class='col-sm-8'>
                <div class='form-group'>
                    ...
                    <input id="dokumen_pasport" name="dokumen_pasport" class="form-control input-sm nomor_sk"
                        ...
                        value="<?php echo e(strtoupper($penduduk['dokumen_pasport'])); ?>"></input>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right" id="tgl_2" name="tanggal_akhir_paspor" type="text"
                    value="<?php echo e($penduduk['tanggal_akhir_paspor']); ?>">
            </div>
        </div>
    </div>
    <div class='col-sm-8' id='field_dokumen_kitas'>
        <div class='form-group'>
            ...
            <input id="dokumen_kitas" name="dokumen_kitas" class="form-control input-sm number" maxlength="45"
                ...
                value="<?php echo e(strtoupper($penduduk['dokumen_kitas'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4' id='field_negara_asal'>
        <div class='form-group'>
            ...
            <input id="negara_asal" name="negara_asal" class="form-control input-sm" maxlength="10" type="text"
                placeholder="Negara Asal" value="<?php echo e(strtoupper($penduduk['negara_asal'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-12'>
        <div class="form-group subtitle_head">
            ...
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <input id="ayah_nik" name="ayah_nik" class="form-control input-sm nik" type="text"
                        placeholder="Nomor NIK Ayah" value="<?php echo e($penduduk['ayah_nik']); ?>"></input>
                </div>
            </div>
            <div class='col-sm-8'>
                <div class='form-group'>
                    ...
                    <input id="nama_ayah" name="nama_ayah" class="form-control input-sm required nama" maxlength="100"
                        type="text" placeholder="Nama Ayah" value="<?php echo e(strtoupper($penduduk['nama_ayah'])); ?>"></input>
                </div>
            </div>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <input id="ibu_nik" name="ibu_nik" class="form-control input-sm nik" type="text" placeholder="Nomor NIK Ibu"
                value="<?php echo e($penduduk['ibu_nik']); ?>"></input>
        </div>
    </div>
    <div class='col-sm-8'>
        <div class='form-group'>
            ...
            <input id="nama_ibu" name="nama_ibu" class="form-control input-sm required nama" maxlength="100" type="text"
                placeholder="Nama Ibu" value="<?php echo e(strtoupper($penduduk['nama_ibu'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-12'>
        <div class="form-group subtitle_head">
    ...
    <div class='col-sm-12'>
        <div class='form-group'>
            ...
            <input id="alamat" name="alamat" class="form-control input-sm nomor_sk" maxlength="200" type="text"
                placeholder="Alamat di Kartu Keluarga" value="<?php echo e($penduduk['alamat']); ?>"></input>
        </div>
    </div>
    <?php endif; ?>
    <?php if(empty($id_kk)): ?>
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group col-sm-3">
                <label for="dusun"><?php echo e(ucwords(setting('sebutan_dusun'))); ?> <?php if(!(empty($penduduk['no_kk']) &&
                    empty($kk_baru))): ?>
                    <?php echo e('KK'); ?>
                ...
                <select id="dusun" class="form-control input-sm select2 required">
                    ...
                    <option value="<?php echo e($keyDusun); ?>" <?= ($keyDusun==$penduduk['wilayah']['dusun']) ? 'selected' : ''; ?>><?php echo e($keyDusun); ?>
            ...
            <div class="form-group col-sm-3">
                ...
                <select id="rw" name="rw" class="form-control input-sm select2 required">
                    ...
                    <optgroup value="<?php echo e($keyDusun); ?>" label="<?php echo e(ucwords(setting('sebutan_dusun')) . ' ' . $keyDusun); ?>"
                        <?= ($penduduk['wilayah']['dusun'] !=$keyDusun) ? 'disabled' : ''; ?>>
                        ...
                        <option value="<?php echo e($keyDusun); ?>__<?php echo e($keyRw); ?>" <?= ($penduduk['wilayah']['rw']==$keyRw &&
                            $penduduk['wilayah']['dusun']==$keyDusun) ? 'selected' : ''; ?>><?php echo e($keyRw); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </optgroup>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group col-sm-3">
                ...
                <select id="id_cluster" name="id_cluster" class="form-control input-sm select2 required">
                    ...
                    <optgroup value="<?php echo e($keyDusun); ?>__<?php echo e($keyRw); ?>" label="<?php echo e('RW ' . $keyRw); ?>"
                        <?= ($penduduk['wilayah']['rw'] !=$keyRw || $penduduk['wilayah']['dusun'] !=$keyDusun) ? 'disabled' : ''; ?>>
                        ...
                        <option value="<?php echo e($rt->id); ?>" <?= ($penduduk['id_cluster']==$rt->id) ? 'selected' : ''; ?>>
                            <?php echo e($rt->rt); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </optgroup>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class='col-sm-12'>
        <div class='form-group'>
            ...
            <input id="alamat_sebelumnya" name="alamat_sebelumnya"
                class="form-control input-sm nomor_sk <?php echo e(jecho($jenis_peristiwa, 5, 'required')); ?>" maxlength="200"
                type="text" placeholder="Alamat Sebelumnya" value="<?php echo e($penduduk['alamat_sebelumnya']); ?>"></input>
        </div>
    </div>
    ...
    <div class='col-sm-12'>
        <div class='form-group'>
            ...
            <input id="alamat_sekarang" name="alamat_sekarang" class="form-control input-sm" maxlength="200" type="text"
                placeholder="Alamat Sekarang" value="<?php echo e($penduduk['alamat_sekarang']); ?>"></input>
        </div>
    </div>
    <?php endif; ?>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <input id="telepon" name="telepon" class="form-control input-sm number" type="text" maxlength="20"
                placeholder="Nomor Telepon" value="<?php echo e($penduduk['telepon']); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <input id="email" name="email" class="form-control input-sm email" maxlength="50" placeholder="Alamat Email"
                value="<?php echo e($penduduk['email']); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <input name="telegram" class="form-control input-sm number" maxlength="100" type="text"
                placeholder="Akun Telegram" value="<?php echo e($penduduk['telegram']); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
        ...
        <div class="row">
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <select class="form-control input-sm required" name="status_kawin" <?php if($jenis_peristiwa=='1' ): ?>
                        onload="disable_kawin_cerai($(this).find(':selected').val())" <?php endif; ?>
                        ...
                        <option value="<?php echo e($key); ?>" <?= ($penduduk['status_kawin']==$key || ($jenis_peristiwa=='1'
                            && $key==1)) ? 'selected' : ''; ?>>
                            <?php echo e(strtoupper($value)); ?>
            ...
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <input id="akta_perkawinan" name="akta_perkawinan" class="form-control input-sm nomor_sk"
                        ...
                        value="<?php echo e($penduduk['akta_perkawinan']); ?>"></input>
                </div>
            </div>
            <div class='col-sm-4'>
                <div class='form-group'>
                    ...
                    <div class="input-group input-group-sm date">
                        ...
                        <input class="form-control input-sm pull-right" id="tgl_3" name="tanggalperkawinan" type="text"
                            value="<?php echo e($penduduk['tanggalperkawinan'] ? date('d-m-Y', strtotime($penduduk['tanggalperkawinan'])) : ''); ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class='col-sm-8'>
        <div class='form-group'>
            ...
            <input id="akta_perceraian" name="akta_perceraian" class="form-control input-sm nomor_sk" maxlength="40"
                ...
                value="<?php echo e(strtoupper($penduduk['akta_perceraian'])); ?>"></input>
        </div>
    </div>
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right tgl_indo" name="tanggalperceraian" type="text"
                    value="<?php echo e($penduduk['tanggalperceraian'] ? date('d-m-Y', strtotime($penduduk['tanggalperceraian'])) : ''); ?>">
            </div>
        </div>
    </div>
    <div class='col-sm-12'>
    ...
    <div id='asuransi_pilihan' class='col-sm-4'>
        <div class='form-group'>
            ...
            <input id="no_asuransi" name="no_asuransi" class="form-control input-sm nomor_sk" type="text"
                maxlength="100" placeholder="Nomor Asuransi" value="<?php echo e($penduduk['no_asuransi']); ?>"></input>
        </div>
    </div>
    <div id="status_asuransi" class="col-sm-4">
        <div class='form-group'>
            ...
            <select class="form-control input-sm" name="status_asuransi">
                <option value="" <?= ($penduduk['status_asuransi']==null) ? 'selected' : ''; ?>>Pilih Kepersertaan Asuransi Kesehatan
                </option>
                ...
                <option value="<?php echo e($key); ?>" <?= (isset($penduduk['status_asuransi']) &&
                    $penduduk['status_asuransi']==$key) ? 'selected' : ''; ?>><?php echo e(strtoupper($value)); ?>
            ...
            <div class="col-sm-4">
                <div class='form-group'>
                    ...
                    <input id="bpjs_ketenagakerjaan" name="bpjs_ketenagakerjaan" class="form-control input-sm nomor_sk"
                        ...
                        value="<?php echo e($penduduk['bpjs_ketenagakerjaan']); ?>"></input>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class='col-sm-8'>
                <div class='form-group'>
                    ...
                    <textarea id="ket" name="ket" class="form-control input-sm" rows="3"
                        placeholder="Keterangan"><?php echo e($penduduk['ket']); ?></textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <?php if($status_pantau): ?>
                ...
                $('#adat').select2({
                    ...
                    ajax: {
                        ...
                        url: "<?php echo e(config_item('server_pantau')); ?>/index.php/api/wilayah/adat?token=<?php echo e(config_item('token_pantau')); ?>",
                        dataType: 'json',
                        delay: 250,
                ...
                $('#suku').select2({
                    ...
                    ajax: {
                        ...
                        url: "<?php echo e(config_item('server_pantau')); ?>/index.php/api/wilayah/suku?token=<?php echo e(config_item('token_pantau')); ?>",
                        dataType: 'json',
                        delay: 250,
                        data: function(params) {
                            return {
                ...
                $('#marga').select2({
                    ...
                    ajax: {
                        url: "<?php echo e(config_item('server_pantau')); ?>/index.php/api/wilayah/marga?token=<?php echo e(config_item('token_pantau')); ?>",
                        dataType: 'json',
                        delay: 250,
                        data: function(params) {
                            return {
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/penduduk/penduduk_form_isian_bersama.blade.php ENDPATH**/ ?>