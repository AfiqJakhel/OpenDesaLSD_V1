<form id="mainform" name="mainform" method="post" class="">
    <div class="box box-info">
        <div class="box-header with-border">
            <a href="<?php echo e(route('bumindes_inventaris_kekayaan.cetak', ['aksi' => 'cetak'])); ?>" target="_blank" class="btn btn-social bg-purple btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Cetak Inventaris">
                <i class="fa fa-print"></i>Cetak
            </a>
            <a href="<?php echo e(route('bumindes_inventaris_kekayaan.cetak', ['aksi' => 'unduh'])); ?>" target="_blank" class="btn btn-social bg-navy btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Inventaris">
            ...
            <div class="row mepet">
                <div class="col-sm-2">
                    <select class="form-control input-sm select2" id="tahun" name="tahun">
                        <option value="<?php echo e(date('Y')); ?>" selected>Pilih Tahun</option>
                        <?php if($min_tahun): ?>
    ...
    <script>
        $(document).ready(function() {
            var TableData = $('#tabeldata').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('bumindes_inventaris_kekayaan.datatables')); ?>",
                    data: function(req) {
                        req.tahun = $('#tahun').val();
                    }
                },
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/dokumen/inventaris_kekayaan/table.blade.php ENDPATH**/ ?>