<?php $__env->startSection('content'); ?>
    <form id="validasi" autocomplete="off" action="<?php echo e($form_action); ?>" method="post" class="space-y-5">
        <!-- NIK Input -->
        <div>
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    id="nik"
                    autocomplete="off" 
                    class="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-accent focus:border-accent transition outline-none text-gray-800 angka required <?php echo jecho($cek_anjungan['keyboard'] == 1, true, 'kbvnumber'); ?>" 
                    name="nik" 
                    maxlength="16" 
        ...
        <div class="space-y-3">
            <!-- E-KTP Login -->
            <a href="<?php echo e(site_url('layanan-mandiri/masuk-ektp')); ?>">
                <button 
                    type="button" 
            ...
            <?php if(setting('tampilkan_pendaftaran')): ?>
                <!-- Register -->
                <a href="<?php echo e(site_url('layanan-mandiri/daftar')); ?>">
                    <button 
                        type="button" 
            ...
            <!-- Forgot PIN -->
            <a href="<?php echo e(site_url('layanan-mandiri/lupa-pin')); ?>">
                <button 
                    type="button" 
            ...
            <?php if($cek_anjungan['tipe'] == 1): ?>
                <!-- Anjungan -->
                <a href="<?php echo e(route('anjungan.index')); ?>">
                    <button 
                        type="button" 
                        class="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3.5 rounded-xl border border-gray-300 transition-all duration-300 flex items-center justify-center gap-2"
                    >
        ...
        <div class="pt-4 text-center">
            <a href="<?php echo e(site_url('/')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-primary transition">
...
<?php echo $__env->make('layanan_mandiri.auth.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/layanan_mandiri/auth/login.blade.php ENDPATH**/ ?>