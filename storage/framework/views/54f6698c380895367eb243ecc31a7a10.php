...
<?php $__env->startSection('title'); ?>
    <h1>
        <?php echo e(setting('sebutan_dtks')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <a href="<?php echo e(ci_route('rtm')); ?>" class="btn btn-social btn-default btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class='fa fa-reply'></i>Kelola Rumah Tangga</a>
            <?php if(can('u')): ?>
            ...
            <a href="<?php echo e(ci_route('dtks/ekspor?versi=' . \App\Enums\Dtks\DtksEnum::VERSION_CODE)); ?>" class="btn btn-social btn-sm bg-navy visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-file"></i> Ekspor ke excel</a>
        </div>
        <div class="box-body">
    ...
    <div class="modal fade" id="modal-survey" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form data-action="<?php echo e(ci_route('dtks.new')); ?>" id="form-new-dtks" method="POST">
    ...
    >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open(ci_route('dtks/cetak2'), 'method="POST"'); ?>
    ...
    >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open(ci_route('dtks/ekspor'), 'method="GET"'); ?>
    ...
    >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open(ci_route('dtks/impor'), 'method="GET"'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var TableData = $('#tabeldata').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(ci_route('dtks.datatables')); ?>",
                columns: [{
                        data: 'ceklist',
                        class: 'padat',
                        searchable: false,
                    ...
                    },
                    {
                        data: function(data) {
                            if (data.anggota_count != null) {
                                return `<a href="<?php echo e(ci_route('dtks.listAnggota')); ?>/${data.id}" title="Lihat Nama Anggota" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Daftar Anggota">${data.anggota_count}</a>`;
                            }
                        },
                        name: 'anggota_count',
                        searchable: false,
            ...
            $('#form-delete-dtks').on('submit', function(ev) {
                ...
                $.ajax({
                        url: "<?php echo e(ci_route('dtks.delete')); ?>" + "/" + dtks_id,
                        method: "POST",
                        data: form
                    })
                    .done(function(data) {
            ...
            $('#cetak_terpilih').on('click', function(ev_cetak_terpilih) {
                ...
                function process_cetak_terpilih(checked) {
                    ajax_save_dtks("<?php echo e(ci_route('dtks/cetak2')); ?>", {
                        id: checked
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/dtks/index.blade.php ENDPATH**/ ?>