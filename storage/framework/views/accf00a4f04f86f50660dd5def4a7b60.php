<form action="<?php echo e($form_action); ?>" method="post" id="validasi">
    <div class="modal-body">
        ...
        <div class="form-group" id="jenis_link" style="<?php if(!$menu['link_tipe']): ?> display:none; <?php endif; ?>">
            ...
            <select id="statistik_kesehatan" class="form-control input-sm jenis_link" name="<?php echo e(jecho($menu['link_tipe'], 12, 'link')); ?>" style="<?php if($menu['link_tipe'] != 12): ?> display:none; <?php endif; ?>">
                <option value="">-- Pilih Statistik Kesehatan --</option>
                <option value="data-kesehatan/stunting" <?= ($menu['link'] == 'data-kesehatan/stunting') ? 'selected' : ''; ?>>Stunting</option>
            </select>
            ...
            <span id="eksternal" class="jenis_link" style="<?php if(!in_array($menu['link_tipe'], [88, 99])): ?> display:none; <?php endif; ?>">
                <input name="<?php echo e(jecho(in_array($menu['link_tipe'], [88, 99]), true, 'link')); ?>" class="form-control input-sm" type="text" value="<?php echo e($menu['link']); ?>" />
        ...
        <div class="form-group">
            ...
            <select name="enabled" class="form-control input-sm required">
                <option value="1" <?= ($menu['enabled'] == 1) ? 'selected' : ''; ?>>Aktif</option>
                <option value="0" <?= ($menu['enabled'] == 0) ? 'selected' : ''; ?>>Tidak Aktif</option>
            </select>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/web/menu/ajax_form.blade.php ENDPATH**/ ?>