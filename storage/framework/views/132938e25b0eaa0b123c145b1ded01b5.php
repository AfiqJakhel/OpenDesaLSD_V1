...
$(document).ready(function () {
    const apiUrl   = `<?php echo e(route('api.produk-hukum')); ?>`;
    const tahunUrl = `<?php echo e(route('api.tahun-produk-hukum')); ?>`;
    const katUrl   = `<?php echo e(route('api.kategori-produk-hukum')); ?>`;
    const PAGE_SIZE = 12;
...
<?php echo $__env->make('theme::layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/produk-hukum/index.blade.php ENDPATH**/ ?>