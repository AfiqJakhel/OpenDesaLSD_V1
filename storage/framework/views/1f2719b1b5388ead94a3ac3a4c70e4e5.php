...
<?php $__env->startSection('content'); ?>
    ...
    <form id="mainform" action="<?php echo e(ci_route('slider.update')); ?>" method="POST" class="form-horizontal">
        <div class="row">
            <div class="col-md-12">
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/web/slider/index.blade.php ENDPATH**/ ?>