...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
        ...
        $.ajax({
                url: '<?php echo e(config_item('server_layanan') . '/api/v1/pelanggan/terdaftar'); ?>',
                type: 'get',
                headers: {
                ...
                data: {
                    desa_id: '<?php echo e(kode_wilayah($desa['kode_desa'])); ?>'
                },
            })
            ...
            .fail(function() {
                $.ajax({
                        url: '<?php echo e(config_item('server_layanan') . '/api/v1/pelanggan/form-register'); ?>',
                        type: 'get',
                        headers: {
                            "Authorization": `Bearer <?php echo e($list_setting->firstWhere('key', 'layanan_opendesa_token')?->value); ?>`,
                            "X-Requested-With": `XMLHttpRequest`,
                    ...
                    $('.content-wrapper').find('button.simpan').click(function(event) {
                        ...
                        setTimeout(function() {
                            ...
                            if (that.valid() == true) {
                                Swal.showLoading()
                                $.ajax({
                                        url: '<?php echo e(config_item('server_layanan') . '/api/v1/pelanggan/register'); ?>',
                                        headers: {
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\Modules\Pelanggan\Views/pendaftarankerjasama/pendaftaran.blade.php ENDPATH**/ ?>