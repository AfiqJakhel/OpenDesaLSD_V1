...
<section class="relative w-full h-[500px] lg:h-[600px] overflow-hidden" x-data="heroCarousel()">
    ...
    <div class="relative w-full h-full">
        ...
        <?php $__currentLoopData = $slider_gambar['gambar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(is_file($img)): ?>
                <div class="absolute inset-0 w-full h-full transition-all duration-600 ease-in-out"
                     :class="currentSlide === <?php echo e($slideIndex); ?> ? 'opacity-100 translate-x-0 z-10' : (currentSlide > <?php echo e($slideIndex); ?> ? 'opacity-0 -translate-x-full z-0' : 'opacity-0 translate-x-full z-0')"
                     style="transition: transform 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.6s;">
                    <!-- Background Image -->
                    <img src="<?php echo e(base_url($img)); ?>" alt="<?php echo e($data['judul']); ?>" class="w-full h-full object-cover">
                    
                    <!-- Overlay -->
                    <div class="absolute inset-0 bg-gradient-to-b from-black/60 via-black/50 to-black/70"></div>
                    
                    <!-- Content Overlay -->
                    <?php if($slider_gambar['sumber'] != 3 && $data['judul']): ?>
                        <div class="absolute bottom-0 left-0 right-0 p-8 lg:p-12">
                            <div class="container mx-auto max-w-7xl">
                                <h2 class="text-2xl lg:text-4xl font-bold text-white mb-3 drop-shadow-lg"><?php echo e($data['judul']); ?></h2>
                                <a href="<?php echo e(site_url('artikel/' . buat_slug($data))); ?>" class="inline-flex items-center gap-2 text-white/90 hover:text-white text-sm lg:text-base font-medium transition">
        ...
        <?php if($slideIndex === 0): ?>
            ...
            <?php $__currentLoopData = $placeholderImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="absolute inset-0 w-full h-full transition-all duration-600 ease-in-out"
                     :class="currentSlide === <?php echo e($slideIndex); ?> ? 'opacity-100 translate-x-0 z-10' : (currentSlide > <?php echo e($slideIndex); ?> ? 'opacity-0 -translate-x-full z-0' : 'opacity-0 translate-x-full z-0')"
                     style="transition: transform 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.6s;">
                    <img src="https://picsum.photos/1920/1080?seed=<?php echo e($seed); ?>" class="w-full h-full object-cover" alt="Hero Background">
                    <div class="absolute inset-0 bg-gradient-to-b from-black/60 via-black/50 to-black/70"></div>
                </div>
                <?php $slideIndex++; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4 pointer-events-none">
        ...
        <p class="text-lg md:text-xl lg:text-2xl text-white/95 font-light mb-8 drop-shadow-lg">
            Kecamatan <?php echo e($desa['nama_kecamatan']); ?>, Kabupaten <?php echo e($desa['nama_kabupaten']); ?>
...
function heroCarousel() {
    return {
        currentSlide: 0,
        totalSlides: <?php echo e($slideIndex); ?>,
...
<section class="relative z-20 -mt-16 container mx-auto px-4 max-w-7xl">
    <div class="grid grid-cols-2 md:grid-cols-6 gap-6">
        ...
        ?>
        <?php $__currentLoopData = $shortcuts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(site_url($item['link'])); ?>" class="bg-white p-6 rounded-2xl card-shadow flex flex-col items-center justify-center gap-4 hover-lift group">
            <div class="w-14 h-14 <?php echo e($item['color']); ?> text-white rounded-2xl flex items-center justify-center text-2xl shadow-lg transition-transform group-hover:rotate-12">
                <i class="fas <?php echo e($item['icon']); ?>"></i>
            </div>
            <span class="font-bold text-gray-800 text-sm whitespace-nowrap"><?php echo e($item['label']); ?></span>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</section>
    ...
    <div class="container mx-auto px-4 max-w-7xl">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7">
                ...
                <h2 class="text-4xl font-extrabold text-primary mt-6 mb-6 leading-tight">Tentang <?php echo e(setting('sebutan_desa') ?? 'Desa'); ?> <?php echo e($desa['nama_desa']); ?></h2>
                ...
                <a href="<?php echo e(site_url('profil_desa')); ?>" class="inline-flex items-center gap-2.5 bg-primary text-white hover:bg-accent px-8 py-3.5 rounded-full font-bold shadow-md hover:shadow-xl hover:-translate-y-0.5 active:scale-95 transition-all duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="flex flex-col">
                <div class="flex justify-between items-end mb-8">
                    ...
                    <a href="<?php echo e(site_url('data-statistik')); ?>" class="bg-primary/5 text-primary px-6 py-2 rounded-full font-bold hover:bg-primary text-sm hover:text-white transition">Selengkapnya</a>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="hidden lg:flex lg:col-span-2 bg-[#0D2247] text-white p-12 flex-col justify-center items-center text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <!-- Logo Nagari -->
                    <div class="mb-8">
                        <img src="<?php echo e(gambar_desa($desa['logo'])); ?>" alt="Logo" class="h-24 w-auto mx-auto drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                    </div>
                    
                    <!-- Nama Nagari -->
                    <h3 class="text-2xl font-bold mb-2 uppercase tracking-tight"><?php echo e($desa['nama_desa']); ?></h3>
                    <p class="text-white/70 text-sm mb-8"><?php echo e($desa['nama_kecamatan']); ?>, <?php echo e($desa['nama_kabupaten']); ?></p>
            ...
            <div class="lg:col-span-3 p-8 md:p-12">
                ...
                <div class="lg:hidden flex justify-center mb-8">
                    <img src="<?php echo e(gambar_desa($desa['logo'])); ?>" alt="Logo" class="h-16 w-auto">
                </div>
                ...
                <div class="max-w-md mx-auto">
                    ...
                    <form action="<?php echo e(site_url('layanan-mandiri/cek')); ?>" method="POST" class="space-y-6">
                        <input type="hidden" name="<?php echo e(get_instance()->security->get_csrf_token_name()); ?>" value="<?php echo e(get_instance()->security->get_csrf_hash()); ?>">
                    ...
                    <div class="text-center mt-8 pt-6 border-t border-gray-100">
                        ...
                        <a href="mailto:<?php echo e($desa['email_desa'] ?? 'admin@desa.id'); ?>" class="text-primary font-semibold text-sm hover:text-accent transition">
...
<section class="py-24 bg-gray-50">
    <div class="container mx-auto px-4 max-w-7xl">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="<?php echo e(site_url('galeri')); ?>" class="hidden md:block bg-white text-primary border border-primary px-8 py-3 rounded-full font-bold hover:bg-primary hover:text-white transition">Lihat Semua Galeri</a>
        </div>
        ...
        <?php if($galeriPhotos->isNotEmpty()): ?>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <?php $__currentLoopData = $galeriPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $fotoUrl = base_url(LOKASI_GALERI . 'sedang_' . $foto->gambar); ?>
                    <a href="<?php echo e($fotoUrl); ?>"
                       ...
                       class="relative group h-64 rounded-2xl overflow-hidden cursor-pointer shadow-md hover:shadow-xl transition-all duration-300 block">
                        <img src="<?php echo e($fotoUrl); ?>"
                             ...
                             alt="<?php echo e($foto->nama ?? 'Galeri'); ?>"
                             loading="lazy">
        ...
        <div class="text-center mt-8 md:hidden">
            <a href="<?php echo e(site_url('galeri')); ?>" class="inline-block bg-white text-primary border border-primary px-8 py-3 rounded-full font-bold hover:bg-primary hover:text-white transition">Lihat Semua Galeri</a>
        </div>
    </div>
</section>
...
<section class="py-24">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <?php if($artikelTerbaru->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <?php $__currentLoopData = $artikelTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group hover:-translate-y-2">
                    <div class="relative h-56 overflow-hidden">
                        <?php if($post->gambar && is_file(LOKASI_FOTO_ARTIKEL . 'kecil_' . $post->gambar)): ?>
                            <img src="<?php echo e(base_url(LOKASI_FOTO_ARTIKEL . 'sedang_' . $post->gambar)); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="<?php echo e($post->judul); ?>">
                        <?php else: ?>
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-accent text-white text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-lg">
                                <?php echo e($post->category->kategori ?? 'Berita'); ?>
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-3 line-clamp-2 leading-tight group-hover:text-primary transition">
                            <a href="<?php echo e($post->url_slug); ?>"><?php echo e($post->judul); ?></a>
                        </h3>
                        <div class="flex items-center gap-4 text-gray-400 text-xs mb-4">
                            <span><i class="far fa-calendar-alt mr-1.5"></i> <?php echo e(tgl_indo($post->tgl_upload)); ?></span>
                            <span><i class="far fa-user mr-1.5"></i> <?php echo e($post->owner); ?></span>
                        </div>
                        <p class="text-gray-500 text-sm line-clamp-3 leading-relaxed mb-4">
                            <?php echo e(strip_tags(substr($post->isi, 0, 150))); ?>...
                        </p>
                        <a href="<?php echo e($post->url_slug); ?>" class="inline-flex items-center gap-2 text-primary font-bold text-sm hover:text-accent transition">
                            Baca Selengkapnya <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="text-center mt-16">
                <a href="<?php echo e(site_url('berita')); ?>" class="inline-block border-2 border-primary text-primary px-12 py-4 rounded-full font-bold hover:bg-primary hover:text-white transition shadow-lg">Buka Semua Berita</a>
            </div>
        <?php else: ?>
            <!-- Empty State -->
...
<script>
    ...
    try {
        ...
        var popupContent = `
            <div class="font-sans">
                <h4 class="font-bold text-[#0D2247] text-[15px] mb-1">Kantor Desa <?php echo e($desa['nama_desa']); ?></h4>
    ...
    try {
        Highcharts.chart('penduduk-chart', {
            ...
            series: [{
                name: 'Populasi',
                data: [
                    { y: <?php echo e($lk); ?>, color: '#3b82f6' },
                    { y: <?php echo e($pr); ?>, color: '#ec4899' },
                    { y: <?php echo e($lk + $pr); ?>, color: '#10b981' }
                ]
            }],
...
<?php echo $__env->make('theme::layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/artikel/index.blade.php ENDPATH**/ ?>