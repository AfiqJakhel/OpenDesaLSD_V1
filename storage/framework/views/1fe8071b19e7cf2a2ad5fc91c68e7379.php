        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="flex flex-col">
                <div class="flex justify-between items-end mb-8">
                    ...
                    <a href="<?php echo e(site_url('statistik/0')); ?>" class="bg-primary/5 text-primary px-6 py-2 rounded-full font-bold hover:bg-primary text-sm hover:text-white transition">Selengkapnya</a>
                </div>
