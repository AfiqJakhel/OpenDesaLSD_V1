<?php if(!empty($widget_keuangan['tahun']) && !is_null($widget_keuangan['tahun'])): ?>
    ...
    <div class="box box-primary box-solid">
        <div class="box-header">
            <h3 class="box-title">
                <i class="fa fa-chart-bar mr-1"></i><?php echo e($judul_widget); ?>
                    ...
                    <div x-data="{
                        ...
                        >
                            <ul class="divide-y text-base font-normal">
                                <?php $__currentLoopData = $widget_keuangan['tahun']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="#!" class="py-2 px-3 block"><?php echo e($key); ?></a></li>
                                    <li><a href="#!" class="py-2 px-3 block" @click="open = false" onclick="gantiTipe('pelaksanaan'); gantiTahun('<?php echo e($key); ?>')">Pelaksanaan
                                            APBDes</a></li>
                                    <li><a href="#!" class="py-2 px-3 block" @click="open = false" onclick="gantiTipe('pendapatan'); gantiTahun('<?php echo e($key); ?>')">Pendapatan
                                            APBDes</a></li>
                                    <li><a href="#!" class="py-2 px-3 block" @click="open = false" onclick="gantiTipe('belanja'); gantiTahun('<?php echo e($key); ?>')">Belanja APBDes</a>
                                    </li>
    ...
    <script type="text/javascript">
        var rawData = <?php echo $widget_keuangan['data']; ?>;
        var year = "<?php echo e($widget_keuangan['tahun_terbaru']); ?>";
        ...
        $(document).ready(function() {
            ...
            $("#keuangan-selector").val("<?php echo e($widget_keuangan['tahun_terbaru']); ?>")
            displayChart(year, tipe);
        });
    </script>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/widgets/keuangan.blade.php ENDPATH**/ ?>