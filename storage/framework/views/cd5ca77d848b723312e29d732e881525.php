...
<script>
    ...
    function cetak() {
        ...
        $("#form-cetak").attr("action", `<?php echo e($action); ?>/${privasi_nik}?${queryString}`);
...
<form target="_blank" action="" method="post" id="form-cetak">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" onclick="cetak()" class="btn btn-social btn-info btn-sm"><i class="fa fa-check"></i> <?php echo e(ucwords($aksi)); ?></button>
    </div>
</form>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/penduduk/ajax_cetak_bersama.blade.php ENDPATH**/ ?>