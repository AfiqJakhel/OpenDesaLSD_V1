        ...
        <form action="<?php echo e($form_action); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <?php if(can('u')): ?>
                <div class="box-footer">
                    ...
                    <?php echo $__env->make('admin.layouts.components.buttons.ekspor_gpx', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        window.onload = function() {
            ...
            var lat = <?php echo e($wil_ini['lat'] ?? ($wil_atas['lat'] ?? config('app.map.point.lat'))); ?>;
            var lng = <?php echo e($wil_ini['lng'] ?? ($wil_atas['lng'] ?? config('app.map.point.lng'))); ?>;
            var zoom = <?php echo e($wil_ini['zoom'] ?? ($wil_atas['zoom'] ?? config('app.map.zoom'))); ?>;
            var posisi = [lat, lng];
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/wilayah/maps_wilayah.blade.php ENDPATH**/ ?>