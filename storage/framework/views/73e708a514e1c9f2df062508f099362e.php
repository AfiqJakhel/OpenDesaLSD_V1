        ...
        <div class="col-sm-9">
            <div class="box box-info">
                <div class="box-header with-border">
                    <?php if(can('u')): ?>
                        <a href="<?php echo e(ci_route('inventaris_peralatan.form')); ?>" class="btn btn-social btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus"></i> Tambah</a>
                    <?php endif; ?>
                    <a
                        href="<?php echo e(ci_route('inventaris_peralatan/dialog/cetak')); ?>"
                    ...
                    <a
                        href="<?php echo e(ci_route('inventaris_peralatan/dialog/unduh')); ?>"
    ...
    <script>
        $(document).ready(function() {
            var TableData = $('#tabeldata').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(ci_route('inventaris_peralatan.datatables')); ?>"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        class: 'padat',
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/inventaris/peralatan/index.blade.php ENDPATH**/ ?>