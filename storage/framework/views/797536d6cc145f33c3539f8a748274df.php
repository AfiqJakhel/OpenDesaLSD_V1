...
<?php $component = App\View\Components\TambahButton::resolve(['url' => 'kehadiran_hari_libur/form'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\ImporButton::resolve(['url' => ci_route('kehadiran_hari_libur.import')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\HapusButton::resolve(['confirmDelete' => 'true','selectData' => 'true','url' => 'kehadiran_hari_libur/delete_all'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\Modules\Kehadiran\Views/backend/hari_libur/index.blade.php ENDPATH**/ ?>