...
<?php $component = App\View\Components\TambahButton::resolve(['url' => 'kategori/ajax_form/' . $parent,'modal' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\HapusButton::resolve(['url' => 'kategori/delete/' . $parent,'confirmDelete' => true,'selectData' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\KembaliButton::resolve(['judul' => 'Kembali ke Daftar Kategori','url' => ''.e(ci_route('kategori')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var TableData = $('#tabeldata').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(ci_route('kategori.datatables')); ?>?parent=<?php echo e($parent); ?>",
                    data: function(req) {
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/web/kategori/index.blade.php ENDPATH**/ ?>