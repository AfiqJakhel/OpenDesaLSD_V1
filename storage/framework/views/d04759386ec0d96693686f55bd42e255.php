...
<?php if(session('warning')): ?>
    <div <?php if(session('autodismiss')): ?> <?php else: ?> id="notifikasi" <?php endif; ?> class="alert alert-warning alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/components/notifikasi.blade.php ENDPATH**/ ?>