...
<section class="relative bg-[#0D2247] text-white overflow-hidden" style="min-height: 280px;">
    ...
    <div class="container mx-auto px-4 max-w-7xl py-16 relative z-10">
        ...
        <h1 class="font-jakarta font-extrabold text-4xl md:text-5xl mt-3 mb-4">Inventaris <?php echo e(ucwords(setting('sebutan_desa'))); ?></h1>
        <p class="text-white/70 max-w-xl font-jakarta">Daftar rekapitulasi kekayaan dan aset yang dimiliki oleh Pemerintah <?php echo e(ucwords(setting('sebutan_desa'))); ?>.</p>
    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function(event) {
            const _url = `<?php echo e(ci_route('internal_api.inventaris')); ?>`
...
<?php echo $__env->make('theme::layouts.full-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/inventaris/index.blade.php ENDPATH**/ ?>