        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body btn-info">
                    <?php echo e($pesan_hapus ?? 'Apakah Anda yakin ingin menghapus data ini?'); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/components/konfirmasi_hapus.blade.php ENDPATH**/ ?>