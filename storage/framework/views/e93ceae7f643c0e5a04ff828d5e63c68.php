                    ...
                    <div class="input-group input-group-sm text-center">
                        <span class="input-group-btn">
                            <?php if($userData->email_verified_at === null && !empty($userData->email)): ?>
                                ...
                                <br />
                            <?php endif; ?>
                            <?php if($userData->telegram_verified_at === null && $list_setting->firstWhere('key', 'telegram_token')?->value != null && !empty($userData->id_telegram)): ?>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/pengguna/index.blade.php ENDPATH**/ ?>