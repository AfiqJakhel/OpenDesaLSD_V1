...
<script>
    $(document).ready(function() {
        ...
        var TableData = $('#tabeldata').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(site_url('teks_berjalan/datatables')); ?>",
                type: "GET",
                data: function(req) {
        ...
        <?php echo $__env->make('admin.layouts.components.draggable', ['urlDraggable' => ci_route('teks_berjalan.tukar')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    });
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/web/teks_berjalan/index.blade.php ENDPATH**/ ?>