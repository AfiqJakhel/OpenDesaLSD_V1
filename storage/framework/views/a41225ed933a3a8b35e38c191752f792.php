        ...
        <div class="col-md-9">
            <div class="box box-info">
                ...
                <div class="box-header with-border">
                    ...
                    <?php endif; ?>
                    <?php if(can('u')): ?>
                        <?php echo $__env->make('admin.layouts.components.tombol_impor_ekspor_grup', ['impor' => ci_route('grup/impor'), 'ekspor' => ci_route('grup/ekspor')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                <div class="box-body">
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/pengaturan/grup/index.blade.php ENDPATH**/ ?>