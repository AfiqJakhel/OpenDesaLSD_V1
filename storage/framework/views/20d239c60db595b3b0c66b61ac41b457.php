...
<div class="container mx-auto px-4 max-w-7xl">
    ...
    <div x-show="activeTab === 'mendatang'" x-transition>
        <?php if($agenda_mendatang->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $agenda_mendatang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="agenda-card">
                    <div class="h-48 overflow-hidden bg-gradient-to-br from-[#3a7d44] to-[#4a9d54] relative">
                        ...
                        <div class="absolute top-4 right-4 bg-white rounded-xl px-4 py-2 text-center shadow-lg">
                            <div class="font-jakarta font-extrabold text-2xl text-[#3a7d44]"><?php echo e($item->tgl_agenda->format('d')); ?></div>
                            <div class="text-xs text-gray-600 font-jakarta font-bold uppercase"><?php echo e($item->tgl_agenda->format('M Y')); ?></div>
                        </div>
                    </div>
                    <div class="p-6">
                        <span class="inline-block text-[11px] font-bold uppercase tracking-widest text-white bg-[#3a7d44] px-3 py-1.5 rounded-full mb-3 font-jakarta">
                            <?php echo e($item->tgl_agenda->format('l, d F Y')); ?>

                        </span>
                        <h3 class="font-jakarta font-bold text-gray-800 text-lg mb-3 line-clamp-2"><?php echo e($item->judul); ?></h3>
                        
                        <div class="space-y-2 mb-4">
                            <?php if($item->lokasi_kegiatan): ?>
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-jakarta font-semibold text-sm text-gray-800"><?php echo e($item->lokasi_kegiatan); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if($item->koordinator_kegiatan): ?>
                                <div class="flex items-start gap-3">
                                    <div class="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-jakarta font-semibold text-sm text-gray-800"><?php echo e($item->koordinator_kegiatan); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    <div x-show="activeTab === 'hari-ini'" x-transition x-cloak>
        <?php if($agenda_hari_ini->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $agenda_hari_ini; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="agenda-card">
    ...
    <div x-show="activeTab === 'selesai'" x-transition x-cloak>
        <?php if($agenda_selesai->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $agenda_selesai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="agenda-card opacity-75">
                    <div class="h-48 overflow-hidden bg-gradient-to-br from-gray-600 to-gray-700 relative">
                        <div class="absolute inset-0 opacity-20" style="background-image: url('https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80'); background-size: cover; background-position: center;"></div>
                        <div class="absolute top-4 right-4 bg-white rounded-xl px-4 py-2 text-center shadow-lg">
                            <div class="font-jakarta font-extrabold text-2xl text-gray-700"><?php echo e($item->tgl_agenda->format('d')); ?></div>
                            <div class="text-xs text-gray-600 font-jakarta font-bold uppercase"><?php echo e($item->tgl_agenda->format('M Y')); ?></div>
                        </div>
                    </div>
                    <div class="p-6">
...
<?php echo $__env->make('theme::layouts.full-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/agenda/index.blade.php ENDPATH**/ ?>