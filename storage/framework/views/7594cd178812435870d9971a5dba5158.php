        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <?php echo $__env->make('admin.layouts.components.tombol_kembali', ['url' => ci_route('pembangunan_dokumentasi.dokumentasi', $pembangunan->id), 'label' => 'Dokumentasi Pembangunan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" name="id_pembangunan" value="<?php echo e($pembangunan->id); ?>">
                            <div class="form-group">
                                ...
                                <div class="btn-group col-sm-8 kiri" data-toggle="buttons">
                                    <label id="label_pilih" class="btn btn-info btn-sm col-sm-3 form-check-label">
                                        <input type="radio" name="jenis_persentase" class="form-check-input" value="1" autocomplete="off" <?= (empty($main) ? 1 : (in_array($main->persentase, $persentase) ? 1 : 2) == 1) ? 'checked' : ''; ?>> Pilih Persentase
                                    </label>
                                    <label id="label_manual" class="btn btn-info btn-sm col-sm-3 form-check-label">
                                        <input type="radio" name="jenis_persentase" class="form-check-input" value="2" autocomplete="off" <?= (empty($main) ? 1 : (in_array($main->persentase, $persentase) ? 1 : 2) == 2) ? 'checked' : ''; ?>> Tulis Manual
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div id="pilih">
                                    <div class="col-sm-7">
                                        <select class="form-control input-sm select2 required" id="id_persentase" name="id_persentase" onchange="show_hide_anggaran(this.value)">
                                            ...
                                            <?php $__currentLoopData = $persentase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>" <?= ($main->persentase == $value) ? 'selected' : ''; ?>><?php echo e($value); ?></option>
                                ...
                                <div id="manual">
                                    <div class="col-sm-7">
                                        <input
                                            ...
                                            value="<?php echo e($main->persentase); ?>"
                                        />
                                    </div>
                                </div>
                            </div>
                            <?php if($main->gambar): ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="hidden" name="old_foto" value="<?php echo e($main->gambar); ?>">
                                        <img class="attachment-img img-responsive img-circle" src="<?php echo e(base_url(LOKASI_GALERI . $main->gambar)); ?>" alt="Gambar Dokumentasi" width="200" height="200">
                                    </div>
                                </div>
                            <?php endif; ?>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="anggaran">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control input-sm" name="perubahan_anggaran" id="ubahanggaran" type="number" min="0" value="<?php echo e($perubahan); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" style="text-align:left;" for="keterangan">Keterangan</label>
                                <div class="col-sm-7">
                                    <textarea rows="5" class="form-control input-sm required" name="keterangan" id="keterangan" placeholder="Keterangan"><?php echo e($main->keterangan); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function pilih_persentase(pilih) {
            ...
            show_hide_anggaran(`<?php echo e($main->persentase); ?>`);
        }
        ...
        function show_hide_anggaran(anggaran) {
            if (anggaran == '100%' || anggaran == '100') {
                ...
                $("#ubahanggaran").val('<?php echo e($perubahan ?? 0); ?>');
            } else {
                $('#anggaran').fadeOut();
        ...
        $(document).ready(function() {
            // pilih_persentase(`<?php echo e(empty($main) ? 1 : (in_array($main->persentase, $persentase) ? 1 : 2)); ?>`);
            // show_hide_anggaran(`<?php echo e($main->persentase); ?>`);
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/pembangunan/dokumentasi/form.blade.php ENDPATH**/ ?>