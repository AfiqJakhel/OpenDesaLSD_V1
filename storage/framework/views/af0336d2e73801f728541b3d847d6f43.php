     ...
     <div class='modal-dialog'>
         <div class='modal-content'>
             ...
             <div class='modal-body btn-info'>
                 <div>Perambah web tidak mengijinkan akses cookie, silakan ijinkan cookie untuk alamat <?= site_url() ?></div>
             </div>
         </div>
     </div>
 </div>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/components/aktifkan_cookie.blade.php ENDPATH**/ ?>