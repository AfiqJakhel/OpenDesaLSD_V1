...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('js/webcam.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/cropper.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/main-camera.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/components/capture.blade.php ENDPATH**/ ?>