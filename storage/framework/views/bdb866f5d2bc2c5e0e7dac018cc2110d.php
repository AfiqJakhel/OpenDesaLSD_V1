            ...
            <div class="col-md-6">
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <a href="<?php echo e(site_url('qrcode')); ?>" class="btn btn-social btn-success btn-sm" style="float: right;" title="Baru"><i class="fa fa-plus"></i> Baru</a>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe width="100%" height="400px" src="<?php echo e(base_url('rfm/dialog.php?type=1&lang=id&field_id=logoqr&fldr=&akey=' . $session->fm_key)); ?>" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('#generate').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(site_url('qrcode/qrcode_generate')); ?>",
                type: 'POST',
                data: {
                    isiqr: isiqr,
                    changeqr: changeqr,
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/qrcode/setting_qr.blade.php ENDPATH**/ ?>