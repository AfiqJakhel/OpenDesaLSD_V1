...
<?php if(isset($single_artikel)): ?>
    ...
    <?php if(trim($single_artikel['gambar']) != ''): ?>
        ...
        <meta property="og:image" content="<?php echo e(base_url(LOKASI_FOTO_ARTIKEL . 'kecil_' . $single_artikel['gambar'])); ?>?v=<?php echo e(time()); ?>" />
        <meta property="og:image:type" content="image/jpeg" />
        <meta itemprop="image" content="<?php echo e(base_url(LOKASI_FOTO_ARTIKEL . 'sedang_' . $single_artikel['gambar'])); ?>?v=<?php echo e(time()); ?>" />
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/commons/meta.blade.php ENDPATH**/ ?>