                            ...
                            <ol>
                                ...
                                <li>Data yang dibutuhkan untuk Impor dengan memenuhi urutan format dan aturan data pada tautan
                                    ...
                                    <div class="timeline-footer col-sm-12">
                                        <a href="<?php echo e($formatImpor); ?>" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" wrap><i class="fa fa-download"></i> Aturan dan Contoh Format Data</a>
                                    </div>
                                </li>
                            </ol>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 col-md-5 col-lg-5">
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control" id="file_path_penduduk" name="userfile">
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-info" id="file_browser_penduduk"><i class="fa fa-search"></i>
                                                        Browse</button>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-md-5 col-lg-4">
                                            <a href="#" class="btn btn-block btn-success btn-sm" id="btn-impor" title="Impor data penduduk hapus data penduduk sebelum impor"> <i class="fa fa-spin fa-refresh"></i> Impor Data
                                                Penduduk</a>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <tr>
                                    <td>
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd><?php echo e($pesan_impor['ganda']); ?></dd>
                                        </dl>
                                    </td>
                                </tr>
                                <?php if($pesan_impor['pesan']): ?>
                                    <tr>
                                        <td>
                                            <dl class="dl-horizontal">
                                                <dt>Rincian Pesan : </dt>
                                                <dd><?php echo $pesan_impor['pesan']; ?></dd>
                                            </dl>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                                <tr>
                                    <td>
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd><?php echo e($pesan_impor['sukses']); ?></dd>
                                        </dl>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $('document').ready(function() {
            ...
            $('#btn-impor').click(function(event) {
                event.preventDefault;
                Swal.fire({
                    title: 'Peringatan',
                    icon: 'warning',
                    html: '<b>Fitur impor hanya akan memperbaharui data penduduk yang sudah ada saja. Dan tidak akan menambah data penduduk baru. Jika akan menambah data baru, ganti status data penduduk menjadi tidak lengkap.</b>',
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/penduduk/impor.blade.php ENDPATH**/ ?>