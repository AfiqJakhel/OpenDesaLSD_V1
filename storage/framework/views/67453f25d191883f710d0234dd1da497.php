<aside class="main-sidebar">
    <section class="sidebar">
        <div class="user-panel">
            <div class="pull-left image" style="margin-left: -10px; margin-right: 15px;">
        ...
        <ul class="sidebar-menu" data-widget="tree" data-accordion="false">
            ...
            <li class="treeview <?= jecho($modul_ini, $mod['slug'], 'active') ?>">
                <a href="<?= (empty($mod['url']) || $mod['url'] == '#') ? 'javascript:void(0)' : ci_route($mod['url']) ?>">
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/partials/sidebar.blade.php ENDPATH**/ ?>