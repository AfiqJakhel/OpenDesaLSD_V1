            ...
            <div class="space-y-6">
                <a href="<?php echo e(site_url('/')); ?>" class="inline-flex items-center gap-4 group">
                    <div class="w-14 h-14 bg-white/10 rounded-2xl p-2 group-hover:bg-white/15 transition-all duration-300 flex items-center justify-center">
                        <img src="<?php echo e(gambar_desa($desa['logo'])); ?>" alt="Logo" class="w-full h-full object-contain brightness-0 invert">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <a href="<?php echo e(site_url('layanan-mandiri')); ?>" class="text-xs text-white/60 hover:text-accent transition flex items-center gap-2">
