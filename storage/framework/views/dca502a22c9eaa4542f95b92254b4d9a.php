...
<div class="container mx-auto px-4 max-w-7xl font-jakarta">
    ...
    <div class="org-tree">
        ...
        <div style="display:flex;justify-content:center;gap:10px;width:100%;max-width:980px;margin-top:-1px;">
            <?php $__currentLoopData = $level3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="org-col" style="flex:1;min-width:0;">
                <div class="v-line" style="height:26px;"></div>
                <div class="node node-<?php echo e($l3['type']); ?>" style="width:100%;">
                    <div class="node-title"><?php echo e($l3['title']); ?></div>
                    <div class="node-name"><?php echo e($l3['name']); ?></div>
                </div>
                <?php if(!empty($l3['staf'])): ?>
                <div class="v-line" style="height:18px;"></div>
                <?php $__currentLoopData = $l3['staf']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="node node-staf" style="width:100%;">
                    <div class="node-title">Staf</div>
                    <div class="node-name"><?php echo e($s); ?></div>
                </div>
            ...
            <div class="org-col" style="flex:1;min-width:0;">
                ...
                <div class="node node-jorong" style="width:100%;">
                    <div class="node-title">
                        <?php if(!empty($j['plt'])): ?><span style="color:#ef4444;">PLT.</span> <?php endif; ?>
                        Kep. Jorong <?php echo e($j['jorong']); ?>

                    </div>
                    <div class="node-name"><?php echo e($j['nama']); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
