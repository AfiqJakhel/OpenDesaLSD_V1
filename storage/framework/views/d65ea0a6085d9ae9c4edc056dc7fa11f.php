...
<section class="relative bg-[#0D2247] text-white overflow-hidden font-jakarta" style="min-height:240px;">
    ...
    <div class="container mx-auto px-4 max-w-7xl py-16 relative z-10">
        <nav class="text-white/50 text-xs mb-4 flex items-center gap-2">
            ...
            <span class="text-white font-semibold">Profil <?php echo e(ucwords(setting('sebutan_desa'))); ?></span>
        </nav>
        <span class="text-amber-400 font-bold tracking-[.2em] text-xs uppercase">RPJM Nagari 2022–2030</span>
        <h1 class="font-extrabold text-4xl md:text-5xl mt-2 mb-2">Profil <?php echo e(ucwords(setting('sebutan_desa'))); ?></h1>
...
<div class="container mx-auto px-4 max-w-7xl py-8">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex items-center gap-4">
            <div class="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style="background:<?php echo e($s['color']); ?>18;">
                <i class="fas <?php echo e($s['icon']); ?> text-lg" style="color:<?php echo e($s['color']); ?>;"></i>
            </div>
            <div>
                <div class="font-extrabold text-xl text-gray-800"><?php echo e($s['value']); ?></div>
                <div class="text-xs text-gray-400 font-medium"><?php echo e($s['label']); ?></div>
            </div>
        </div>
    ...
    <div class="rpjm-card p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex gap-3 p-4 bg-gray-50 rounded-xl">
                <div class="w-8 h-8 bg-[#0D2247] text-white rounded-lg flex items-center justify-center font-bold text-sm flex-shrink-0"><?php echo e($t['no']); ?></div>
                <div>
                    <div class="font-bold text-gray-800 text-sm"><?php echo e($t['judul']); ?></div>
                    <div class="text-gray-500 text-xs mt-1 leading-relaxed"><?php echo e($t['desc']); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<div id="bab2" class="bab-content space-y-8">
        ...
        <div class="rpjm-card p-6">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                        <div class="font-bold text-gray-800 text-sm"><?php echo e($j['nama']); ?></div>
                        <div class="text-gray-400 text-xs">Kepala Jorong: <?php echo e($j['kepala']); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <div class="rpjm-card p-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            <div class="text-center p-4 bg-gray-50 rounded-xl">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center mx-auto mb-2" style="background:<?php echo e($l['color']); ?>15;">
                    <i class="fas <?php echo e($l['icon']); ?> text-sm" style="color:<?php echo e($l['color']); ?>;"></i>
                </div>
                <div class="font-bold text-gray-800 text-sm"><?php echo e($l['luas']); ?></div>
                <div class="text-gray-400 text-xs mt-1"><?php echo e($l['nama']); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="rpjm-card p-6">
            ...
            <div class="space-y-1 text-sm">
                <div class="info-row"><span class="info-label">Jumlah Penduduk</span><span class="info-value font-bold"><?php echo e(number_format($totalJiwa)); ?> Jiwa</span></div>
                <div class="info-row"><span class="info-label">Kepala Keluarga</span><span class="info-value"><?php echo e(number_format($totalKK)); ?> KK</span></div>
        ...
        <div class="rpjm-card p-6">
            ...
            <div class="space-y-2 text-sm">
                ...
                <?php $__currentLoopData = $walinagari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-3 p-2.5 <?php echo e($loop->last ? 'bg-[#0D2247] text-white rounded-xl' : 'border-b border-gray-100'); ?>">
                    <div class="text-xs font-mono <?php echo e($loop->last ? 'text-white/70' : 'text-gray-400'); ?> min-w-[90px]"><?php echo e($w['periode']); ?></div>
                    <div>
                        <div class="font-bold <?php echo e($loop->last ? 'text-white' : 'text-gray-800'); ?> text-sm"><?php echo e($w['nama']); ?></div>
                        <div class="<?php echo e($loop->last ? 'text-amber-400' : 'text-gray-400'); ?> text-xs"><?php echo e($w['ket']); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<div id="bab3" class="bab-content space-y-8">
    ...
    <div class="rpjm-card p-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
            ...
            <div class="text-center p-4 rounded-xl" style="background:<?php echo e($s['color']); ?>10; border: 1.5px solid <?php echo e($s['color']); ?>22;">
                <i class="fas <?php echo e($s['icon']); ?> text-xl mb-2" style="color:<?php echo e($s['color']); ?>;"></i>
                <div class="text-xs font-semibold text-gray-700"><?php echo e($s['nama']); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<div id="bab4" class="bab-content space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <?php $__currentLoopData = $masalah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="rpjm-card p-5">
            <div class="flex items-center gap-3 mb-4">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background:<?php echo e($m['color']); ?>15;">
                    <i class="fas <?php echo e($m['icon']); ?> text-sm" style="color:<?php echo e($m['color']); ?>;"></i>
                </div>
                <h4 class="font-bold text-gray-800"><?php echo e($m['bidang']); ?></h4>
            </div>
            <ul class="rpjm-prose text-sm space-y-2">
                <?php $__currentLoopData = $m['isu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-start gap-2">
                    <i class="fas fa-chevron-right text-[9px] mt-1.5 flex-shrink-0" style="color:<?php echo e($m['color']); ?>;"></i>
...
<div id="bab5" class="bab-content space-y-8">
    ...
    <div class="relative bg-[#0D2247] rounded-3xl overflow-hidden p-8 md:p-12 text-white text-center">
        ...
        <div class="relative z-10">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                <?php $__currentLoopData = ['Madani','Sejahtera','Berbudaya','ABS-SBK']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="bg-white/15 text-white text-xs font-bold px-4 py-1.5 rounded-full"><?php echo e($k); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="space-y-3">
            ...
            <?php $__currentLoopData = $misi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="misi-card flex items-start gap-4">
                <div class="w-8 h-8 bg-[#0D2247] text-white rounded-lg flex items-center justify-center font-extrabold text-sm flex-shrink-0"><?php echo e($i+1); ?></div>
                <p class="text-gray-700 text-sm leading-relaxed pt-1"><?php echo e($m); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="rpjm-card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <?php $__currentLoopData = $tujuanSasaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-4 rounded-xl" style="background:<?php echo e($ts['color']); ?>08; border-left: 3px solid <?php echo e($ts['color']); ?>;">
                <div class="text-xs font-bold uppercase tracking-widest mb-2" style="color:<?php echo e($ts['color']); ?>;"><?php echo e($ts['misi']); ?></div>
                <p class="text-gray-700 text-sm leading-relaxed"><?php echo e($ts['tujuan']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<div id="bab6" class="bab-content space-y-8">
    ...
    <div class="space-y-4">
        ...
        <?php $__currentLoopData = $strategi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="rpjm-card overflow-hidden">
            <div class="flex items-center gap-3 px-5 py-4" style="background:<?php echo e($s['color']); ?>10; border-left: 4px solid <?php echo e($s['color']); ?>;">
                <div class="font-bold text-sm" style="color:<?php echo e($s['color']); ?>;"><?php echo e($s['misi']); ?></div>
            </div>
            <div class="px-5 py-4">
                <ul class="space-y-2">
                    <?php $__currentLoopData = $s['strategi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-start gap-2 text-sm text-gray-700">
                        <i class="fas fa-arrow-right text-[10px] mt-1.5 flex-shrink-0" style="color:<?php echo e($s['color']); ?>;"></i>
...
<div id="bab7" class="bab-content space-y-8">
    ...
    <div class="grid grid-cols-1 gap-5">
        ...
        <div class="rpjm-card overflow-hidden">
            <div class="flex items-center gap-4 p-5" style="background:<?php echo e($b['color']); ?>;">
                <div class="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
                    <i class="fas <?php echo e($b['icon']); ?> text-white text-sm"></i>
                </div>
                <div>
                    <div class="text-white/70 text-xs font-semibold">Bidang <?php echo e($b['no']); ?> dari 5</div>
                    <div class="font-bold text-white"><?php echo e($b['nama']); ?></div>
                </div>
            </div>
            <div class="p-5">
                <ul class="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <?php $__currentLoopData = $b['program']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-start gap-2 text-sm text-gray-700">
                        <i class="fas fa-check text-[10px] mt-1.5 flex-shrink-0" style="color:<?php echo e($b['color']); ?>;"></i>
...
<div id="bab8" class="bab-content space-y-8">
    ...
    <div class="space-y-4">
        ...
        <?php $__currentLoopData = $prioritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="rpjm-card p-5">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background:<?php echo e($p['color']); ?>15;">
                        <i class="fas <?php echo e($p['icon']); ?> text-sm" style="color:<?php echo e($p['color']); ?>;"></i>
                    </div>
                    <div class="font-bold text-gray-800"><?php echo e($p['bidang']); ?></div>
                </div>
                <div class="font-extrabold text-lg" style="color:<?php echo e($p['color']); ?>;"><?php echo e($p['alokasi']); ?></div>
            </div>
            <div class="w-full bg-gray-100 rounded-full h-2 mb-4">
                <div class="h-2 rounded-full" style="width:<?php echo e($p['alokasi']); ?>;background:<?php echo e($p['color']); ?>;"></div>
            </div>
            <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                <?php $__currentLoopData = $p['rincian']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-start gap-2 text-gray-600">
                    <i class="fas fa-circle text-[6px] mt-2 flex-shrink-0" style="color:<?php echo e($p['color']); ?>;"></i>
...
<div id="bab9" class="bab-content space-y-8">
    ...
    <div class="rpjm-card p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <?php $__currentLoopData = $kpi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background:<?php echo e($k['color']); ?>12;">
                    <i class="fas <?php echo e($k['icon']); ?> text-sm" style="color:<?php echo e($k['color']); ?>;"></i>
                </div>
                <div>
                    <div class="text-xs text-gray-500"><?php echo e($k['label']); ?></div>
                    <div class="font-bold text-gray-800 text-sm">Target: <?php echo e($k['target']); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('theme::layouts.full-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/profil_desa/index.blade.php ENDPATH**/ ?>