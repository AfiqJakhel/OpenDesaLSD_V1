...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="info-sync">
        ...
        <ol style="padding: 0 0 0 25px;">
            ...
            <li>
                ...
                (sumber <a id="rtm_clear" href="<?php echo e(ci_route('rtm/clear')); ?>">Kependudukan/Rumah Tangga</a> hanya yang
                berstatus
                masih hidup)
            </li>
            <li>
    ...
    <div class="tab-pane" id="dtks-info-program-keluarga">
        <?php echo form_open(ci_route('dtks.savePengaturan') . '/2', 'class="form-program" id="form-program-keluarga"'); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501a" class="form-control input-sm select2" style="width:100%;">
                                ...
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501a . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501b" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_keluarga as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501b . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501c" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_keluarga as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501c . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501d" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_keluarga as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501d . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501e" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_keluarga as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501e . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501f" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_keluarga as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501f . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="501g" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_keluarga as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_501g . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
    ...
    <div class="tab-pane" id="dtks-info-program-anggota">
        <?php echo form_open(ci_route('dtks.savePengaturan') . '/2', 'class="form-program" id="form-program-anggota"'); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431a1" class="form-control input-sm select2" style="width:100%;">
                                ...
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431a1 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                        ...
                        <td rowspan="4">
                            ...
                            <select name="431a1_431a4_default" class="form-control input-sm select2" style="width:100%;">
                                ...
                                <option value="0" <?= (($name_431a1_431a4_default . '' ?? '') == '0') ? 'selected' : ''; ?>>0. Tidak Memiliki</option>
                                <option value="99" <?= (($name_431a1_431a4_default . '' ?? '') == '99') ? 'selected' : ''; ?>>99. Tidak Tahu</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="431a2" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431a2 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431a3" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431a3 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431a4" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431a4 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431b" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431b . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                        ...
                        <td>
                            <select name="431b_default" class="form-control input-sm select2" style="width:100%;">
                                ...
                                <option value="2" <?= (($name_431b_default . '' ?? '') == '2') ? 'selected' : ''; ?>>2. Tidak</option>
                                <option value="8" <?= (($name_431b_default . '' ?? '') == '8') ? 'selected' : ''; ?>>8. Tidak Tahu</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="431c" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431c . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                        ...
                        <td>
                            <select name="431c_default" class="form-control input-sm select2" style="width:100%;">
                                <option value="">Sesuaikan manual</option>
                                <option value="2" <?= (($name_431c_default . '' ?? '') == '2') ? 'selected' : ''; ?>>2. Tidak</option>
                                <option value="8" <?= (($name_431c_default . '' ?? '') == '8') ? 'selected' : ''; ?>>8. Tidak Tahu</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="431d" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431d . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                        ...
                        <td>
                            <select name="431d_default" class="form-control input-sm select2" style="width:100%;">
                                <option value="">Sesuaikan manual</option>
                                <option value="2" <?= (($name_431d_default . '' ?? '') == '2') ? 'selected' : ''; ?>>2. Tidak</option>
                                <option value="8" <?= (($name_431d_default . '' ?? '') == '8') ? 'selected' : ''; ?>>8. Tidak Tahu</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="431e" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431e . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                        ...
                        <td>
                            <select name="431e_default" class="form-control input-sm select2" style="width:100%;">
                                <option value="">Sesuaikan manual</option>
                                <option value="2" <?= (($name_431e_default . '' ?? '') == '2') ? 'selected' : ''; ?>>2. Tidak</option>
                                <option value="8" <?= (($name_431e_default . '' ?? '') == '8') ? 'selected' : ''; ?>>8. Tidak Tahu</option>
                            </select>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431f1" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431f1 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                        ...
                        <td rowspan="5">
                            ...
                            <select name="431f1_431f5_default" class="form-control input-sm select2" style="width:100%;">
                                <option value="">Sesuaikan manual</option>
                                <option value="0" <?= (($name_431f1_431f5_default . '' ?? '') == '0') ? 'selected' : ''; ?>>0. Tidak Memiliki</option>
                                <option value="99" <?= (($name_431f1_431f5_default . '' ?? '') == '99') ? 'selected' : ''; ?>>99. Tidak Tahu</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="431f2" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431f2 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431f3" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431f3 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431f4" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431f4 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="431f5" class="form-control input-sm select2" style="width:100%;">
                                <option disabled selected value="">----- Pilih -----</option>
                                <?php foreach($daftar_bantuan_anggota as $item): ?>
                                <option value="<?= $item->id ?>" <?= ($item->id . '' === ($name_431f5 . '' ?? '')) ? 'selected' : ''; ?>>
                                    <?php echo e($item->nama); ?> | <?php echo e($item->sdate); ?> s.d <?php echo e($item->edate); ?> | Asal Dana :
                                    <?php echo e($item->asaldana); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.form-program').on('submit', function(ev) {
            ...
            //     });
            // });
            ajax_save_dtks("<?php echo e(ci_route('dtks.savePengaturan') . '/' . 2); ?>", form);
        });
    });
</script>
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/dtks/2/info.blade.php ENDPATH**/ ?>