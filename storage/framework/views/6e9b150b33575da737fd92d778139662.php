...
<head>
    ...
    <!-- Modern Admin Theme -->
    <link rel="stylesheet" href="<?php echo e(asset('css/admin-modern.css')); ?>" />
    <!-- Loading Lazy -->
...
<body id="sidebar_collapse" class="<?php echo e(setting('warna_tema_admin')); ?> fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        var SYARAT_SANDI = "<?php echo e(SYARAT_SANDI); ?>";
    </script>
    <!-- jQuery 3 -->
    ...
    <script>
        $(document).ready(function() {
            $('ul.sidebar-menu').on('expanded.tree', function(e) {
                ...
                // setTimeout(scrollTampil($('li.treeview.menu-open')[0]), 500); // Dinonaktifkan agar tidak mengganggu scroll
            });
    ...
    <?php if(isset($perbaharui_langganan) && $controller != 'pengguna' && !config_item('demo_mode')): ?>
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/index.blade.php ENDPATH**/ ?>