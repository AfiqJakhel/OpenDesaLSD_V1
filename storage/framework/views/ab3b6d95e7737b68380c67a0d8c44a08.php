...
<div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    <div class="chart-card lg:col-span-3">
        ...
        <div class="p-6 space-y-4">
            ...
            $max_j = 3494;
            ?>
            <?php $__currentLoopData = $jorongs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $tot_j = $j['lk']+$j['pr']; $pct_j = round($tot_j/$max_j*100); ?>
            <div>
                <div class="flex justify-between mb-1">
                    <div class="flex items-center gap-2">
                        <span class="w-2.5 h-2.5 rounded-full flex-shrink-0" style="background:<?php echo e($j['color']); ?>"></span>
                        <span class="text-sm font-semibold text-gray-700"><?php echo e($j['nama']); ?></span>
                        <span class="text-[10px] text-gray-400"><?php echo e($j['kk']); ?> KK</span>
                    </div>
                    <div class="text-sm font-extrabold" style="color:<?php echo e($j['color']); ?>"><?php echo e(number_format($tot_j)); ?> jiwa</div>
                </div>
                <div class="h-2.5 bg-gray-100 rounded-full overflow-hidden">
                    <div class="bar-h" style="width:<?php echo e($pct_j); ?>%;background:<?php echo e($j['color']); ?>;"></div>
                </div>
                <div class="flex gap-3 mt-0.5">
                    <span class="text-[10px] text-blue-500">♂ <?php echo e(number_format($j['lk'])); ?></span>
                    <span class="text-[10px] text-pink-500">♀ <?php echo e(number_format($j['pr'])); ?></span>
                </div>
            </div>
    ...
    <div class="lg:col-span-2 space-y-5">
        <div class="chart-card">
            ...
            <div class="p-5 space-y-3">
                ...
                ?>
                <?php $__currentLoopData = $agamas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $tot_ag=$ag['lk']+$ag['pr']; $pct_ag=round($tot_ag/9969*100,1); ?>
                <div>
                    <div class="flex justify-between mb-1">
                        <span class="text-sm font-semibold text-gray-700"><?php echo e($ag['nama']); ?></span>
                        <span class="text-sm font-extrabold" style="color:<?php echo e($ag['color']); ?>"><?php echo e(number_format($tot_ag)); ?> <span class="text-xs font-normal text-gray-400">(<?php echo e($pct_ag); ?>%)</span></span>
                    </div>
                    <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div class="bar-h" style="width:<?php echo e($pct_ag); ?>%;background:<?php echo e($ag['color']); ?>;height:8px;"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="chart-card">
            ...
            <div class="p-5 space-y-3">
                ...
                ?>
                <?php $__currentLoopData = $angkatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $pct_ak=round($ak['val']/9969*100,1); ?>
                <div>
                    <div class="flex justify-between mb-1">
                        <span class="text-xs font-semibold text-gray-600"><?php echo e($ak['label']); ?></span>
                        <span class="text-xs font-bold" style="color:<?php echo e($ak['color']); ?>"><?php echo e(number_format($ak['val'])); ?> (<?php echo e($pct_ak); ?>%)</span>
                    </div>
                    <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div class="bar-h" style="width:<?php echo e($pct_ak); ?>%;background:<?php echo e($ak['color']); ?>;height:8px;"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full tbl">
            ...
            <tbody>
                ...
                ?>
                <?php $__currentLoopData = $tbl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <tr>
                    <td class="text-gray-400 font-semibold" style="padding-left:1.25rem;"><?php echo e($i+1); ?></td>
                    <td>
                        <div class="flex items-center gap-2">
                            <span class="w-2.5 h-2.5 rounded-full" style="background:<?php echo e($r['color']); ?>"></span>
                            <span class="font-semibold text-gray-800"><?php echo e($r['nama']); ?></span>
                        </div>
                    </td>
                    <td class="text-center text-blue-600 font-bold"><?php echo e(number_format($r['lk'])); ?></td>
                    <td class="text-center text-pink-500 font-bold"><?php echo e(number_format($r['pr'])); ?></td>
                    <td class="text-center font-extrabold text-gray-800"><?php echo e(number_format($tot_r)); ?></td>
                    <td class="text-center text-blue-500"><?php echo e(number_format($r['kk_lk'])); ?></td>
                    <td class="text-center text-pink-400"><?php echo e(number_format($r['kk_pr'])); ?></td>
                    <td class="text-center font-bold text-gray-700"><?php echo e(number_format($kk_tot)); ?></td>
                    <td class="text-center">
                        <span class="text-[10px] font-bold px-2 py-0.5 rounded-full" style="background:<?php echo e($r['color']); ?>18;color:<?php echo e($r['color']); ?>;"><?php echo e($pct_r); ?>%</span>
                    </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr style="background:#0D224710;">
                    <td colspan="2" class="font-extrabold text-[#0D2247]" style="padding-left:1.25rem;">JUMLAH</td>
                    <td class="text-center font-extrabold text-blue-700"><?php echo e(number_format($g_lk)); ?></td>
                    <td class="text-center font-extrabold text-pink-600"><?php echo e(number_format($g_pr)); ?></td>
                    <td class="text-center font-extrabold text-gray-900">9.969</td>
                    <td class="text-center font-bold text-blue-600"><?php echo e(number_format($g_kk_lk)); ?></td>
                    <td class="text-center font-bold text-pink-500"><?php echo e(number_format($g_kk_pr)); ?></td>
...
<?php echo $__env->make('theme::layouts.full-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/statistik/default.blade.php ENDPATH**/ ?>