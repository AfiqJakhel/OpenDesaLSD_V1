    ...
    <div class='modal-dialog'>
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                ...
                <a class='btn-ok' href="<?php echo e(ci_route('database.acak')); ?>">
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/pengaturan/modul/acak_modal.blade.php ENDPATH**/ ?>