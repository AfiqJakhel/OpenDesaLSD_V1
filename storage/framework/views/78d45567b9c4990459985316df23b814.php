<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <!-- Judul Halaman di Tengah Navbar (Modern) -->
        <div class="navbar-page-title hidden-xs">
            Admin <span class="navbar-page-subtitle">/ Dashboard</span>
        </div>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <?php if(can('b', 'komentar')): ?>
                    <li>
                        <a href="<?php echo e(ci_route('komentar')); ?>?status=<?php echo e(App\Models\Komentar::UNREAD); ?>">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="display: flex; align-items: center; gap: 6px;">
                    <img src="<?php echo e(AmbilFoto($auth->foto)); ?>" class="user-image" alt="User Image" />
                    <span class="hidden-xs" style="line-height: normal;"><?php echo e($auth->nama); ?></span>
                    <i class="fa fa-chevron-down hidden-xs" style="font-size: 10px; color: var(--text-muted); line-height: normal;"></i>
                </a>
                <ul class="dropdown-menu">
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/layouts/partials/header.blade.php ENDPATH**/ ?>