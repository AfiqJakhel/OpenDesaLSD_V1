<?php if(!empty($widget_keuangan['tahun']) && null !== $widget_keuangan['tahun']): ?>
    ...
    <div class="box box-primary box-solid">
        <div class="box-header">
            <h3 class="box-title"><i class="fa fa-bar-chart"></i>&ensp;<?php echo e($judul_widget); ?></h3>
        </div>
        <div class="box-body">
                    ...
                    <div class="dropdown" style="position: absolute; top: 14px;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left">
                            <?php $__currentLoopData = $widget_keuangan['tahun']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a class="dropdown-item"><b><?php echo e($key); ?></b></a></li>
                                <li><a class="dropdown-item" onclick="gantiTipe('pelaksanaan'); gantiTahun('<?php echo e($key); ?>')">Pelaksanaan APBDes</a></li>
                                <li><a class="dropdown-item" onclick="gantiTipe('pendapatan'); gantiTahun('<?php echo e($key); ?>')">Pendapatan APBDes</a></li>
                                <li><a class="dropdown-item" onclick="gantiTipe('belanja'); gantiTahun('<?php echo e($key); ?>')">Belanja APBDes</a></li>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/natra/resources/views/widgets/keuangan.blade.php ENDPATH**/ ?>