<div class="modal fade in" id="impor-surat">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open(ci_route('surat_dinas.impor'), 'id="validasi" enctype="multipart/form-data"'); ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <a href="<?php echo e($suratDinasBawaan); ?>" class="btn btn-social bg-navy btn-sm" target="_blank">
...
<?php /**PATH C:\xampp\htdocs\OpenSID\resources\views/admin/surat_dinas/pengaturan/impor.blade.php ENDPATH**/ ?>