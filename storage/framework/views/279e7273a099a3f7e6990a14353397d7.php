...
<section class="relative bg-[#0D2247] text-white overflow-hidden" style="min-height: 280px;">
    ...
    <div class="container mx-auto px-4 max-w-7xl py-16 relative z-10">
        <nav class="text-white/60 text-sm mb-6 font-jakarta flex items-center gap-2">
            ...
            <span class="text-white font-semibold"><?php echo e($title ?? 'Berita & Artikel'); ?></span>
        </nav>
        <span class="text-amber-400 font-bold tracking-[0.2em] text-xs uppercase font-jakarta">Informasi Publik</span>
        <h1 class="font-jakarta font-extrabold text-4xl md:text-5xl mt-3 mb-4"><?php echo e($title ?? 'Berita & Artikel'); ?></h1>
        <p class="text-white/70 max-w-xl font-jakarta">Informasi terkini, pengumuman, dan artikel terbaru dari <?php echo e(ucwords(setting('sebutan_desa'))); ?> <?php echo e(ucwords(identitas('nama_desa'))); ?>.</p>
    </div>
...
<div class="bg-gray-50 min-h-screen py-10 pb-20">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6 mb-10 flex flex-col md:flex-row gap-4 justify-between items-center transform -translate-y-6 relative z-20 mx-auto max-w-4xl">
            <form action="<?php echo e(site_url(uri_string())); ?>" method="GET" class="w-full flex gap-3">
                <?php if(request()->get('kategori')): ?>
                    <input type="hidden" name="kategori" value="<?php echo e(request()->get('kategori')); ?>">
                <?php endif; ?>
                <div class="relative flex-grow">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                        <i class="fas fa-search"></i>
                    </span>
                    <input type="text" name="cari" value="<?php echo e($cari ?? ''); ?>" placeholder="Cari judul atau isi berita..." class="w-full py-3 pl-11 pr-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0D2247] focus:border-transparent font-jakarta transition duration-200" autocomplete="off">
                </div>
        ...
        <div class="mb-8 flex justify-between items-center">
            <p class="text-gray-600 font-jakarta text-sm">
                Hasil pencarian untuk <span class="font-bold text-gray-800">"<?php echo e(e($cari)); ?>"</span> 
                <span class="bg-gray-200 text-gray-700 px-2.5 py-0.5 rounded-full text-xs ml-2 font-bold"><?php echo e($artikel->total()); ?> Ditemukan</span>
            </p>
            <a href="<?php echo e(site_url(uri_string())); ?>" class="text-red-500 hover:text-red-700 text-sm font-semibold font-jakarta inline-flex items-center gap-1 transition">
        ...
        <?php if($artikel->isNotEmpty()): ?>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col group">
                    <div class="relative h-48 overflow-hidden">
                        <img class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500"
                            src="<?php echo e($gambarSrc); ?>" alt="<?php echo e($post->judul); ?>" onerror="this.src='https://images.unsplash.com/photo-1585829365295-ab7cd400c167?w=800&q=80'" />
                        <div class="absolute top-4 left-4">
                            <span class="bg-accent text-white text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-lg">
                                <?php echo e($post->kategori ?? 'Berita'); ?>
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="flex items-center gap-3 text-xs text-gray-500 mb-3 font-medium font-jakarta">
                            <span class="flex items-center gap-1.5"><i class="fas fa-calendar-alt text-gray-400"></i> <?php echo e(tgl_indo($post->tgl_upload)); ?></span>
                            <?php if(!empty($post->owner)): ?>
                            <span class="flex items-center gap-1.5"><i class="fas fa-user text-gray-400"></i> <?php echo e($post->owner); ?></span>
                            <?php endif; ?>
                        </div>
                        ...
                        <h3 class="font-jakarta font-bold text-lg text-gray-800 leading-tight mb-3 line-clamp-2 group-hover:text-[#0D2247] transition-colors duration-200">
                            <a href="<?php echo e($urlPost); ?>"><?php echo e($post->judul); ?></a>
                        </h3>
                        ...
                        <div class="pt-4 border-t border-gray-100 mt-auto">
                            <a href="<?php echo e($urlPost); ?>" class="inline-flex justify-between items-center w-full group/btn text-[#0D2247] font-semibold text-sm font-jakarta transition duration-200 hover:text-blue-600">
            ...
            <?php if($artikel->lastPage() > 1): ?>
            <div class="mt-12 flex justify-center w-full">
                <?php echo e($artikel->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('theme::layouts.full-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID\/storage/app/themes/esensi/resources/views/partials/berita/index.blade.php ENDPATH**/ ?>