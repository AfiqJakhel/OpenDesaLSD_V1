                ...
                <table id="inventaris" class="table-modern w-full text-left text-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="rounded-tr-xl text-center" rowspan="2">Nilai Kontrak (Rp)</th>
                        </tr>
                        <tr>
                    ...
                    <tfoot id="inventaris-tfoot">
                        <tr>
                            <th colspan="9" class="text-right font-bold bg-gray-50 border-t-2 border-gray-200">Total:</th>
