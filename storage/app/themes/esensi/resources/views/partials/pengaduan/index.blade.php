...
<section class="relative bg-[#0D2247] text-white overflow-hidden font-jakarta" style="min-height:220px;">
    ...
    <div class="container mx-auto px-4 max-w-7xl py-14 relative z-10">
        ...
        <nav class="flex items-center gap-2 text-xs mb-5">
            <a href="{{ ci_route() }}" class="text-white/60 hover:text-white transition">Beranda</a>
                    ...
                    <div class="modal-body relative p-5 lg:p-8 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="nik" type="text" maxlength="16" class="form-input w-full rounded-xl border-gray-200 focus:border-[#0D2247] focus:ring-0 bg-gray-50" placeholder="Masukkan NIK" value="{{ $data['nik'] }}">
                            </div>
                            <div>
                                ...
                                <input name="nama" type="text" required class="form-input w-full rounded-xl border-gray-200 focus:border-[#0D2247] focus:ring-0 bg-gray-50" placeholder="Nama Lengkap" value="{{ $data['nama'] }}">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Email</label>
                                <input name="email" type="email" class="form-input w-full rounded-xl border-gray-200 focus:border-[#0D2247] focus:ring-0 bg-gray-50" placeholder="Alamat Email" value="{{ $data['email'] }}">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Nomor Telepon</label>
                                <input name="telepon" type="text" class="form-input w-full rounded-xl border-gray-200 focus:border-[#0D2247] focus:ring-0 bg-gray-50" placeholder="No. Telepon / WA" value="{{ $data['telepon'] }}">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input name="judul" type="text" class="form-input w-full rounded-xl border-gray-200 focus:border-[#0D2247] focus:ring-0 bg-gray-50" required placeholder="Judul Pengaduan" value="{{ $data['judul'] }}">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="isi" required class="form-textarea w-full rounded-xl border-gray-200 focus:border-[#0D2247] focus:ring-0 bg-gray-50 resize-none" placeholder="Deskripsikan pengaduan Anda secara detail..." rows="4">{{ $data['isi'] }}</textarea>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 items-center">
                                <div class="flex-shrink-0 relative group cursor-pointer" onclick="document.getElementById('captcha').src = '{{ ci_route('captcha') }}?' + Math.random();">
                                    <img id="captcha" src="{{ ci_route('captcha') }}" alt="CAPTCHA Image" class="rounded-lg shadow-sm border border-gray-200 bg-white p-1 h-12 w-auto">
