{{--
| empty_state.blade.php
| ──────────────────────────────────────────────────────────────
| View reusable untuk menampilkan halaman "belum ada data".
|
| Penggunaan:
|   @include('theme::partials.empty_state', [
|       'title'       => 'Nama Halaman',
|       'description' => 'Deskripsi singkat (opsional)',
|       'icon'        => 'fa-file-alt',   // Font Awesome class (opsional)
|       'back_url'    => site_url('/'),    // URL tombol kembali (opsional)
|       'back_label'  => 'Kembali ke Beranda', // Label tombol (opsional)
|   ])
--}}
@php
...
<div class="es-wrap">
    ...
    <h2 class="es-title">Halaman {{ $esTitle }}</h2>
    <p class="es-desc">{{ $esDesc }}</p>

    <a href="{{ $esBackUrl }}" class="es-btn">
