...
$(document).ready(function() {
    ...
    function initProdukHukumTable(tableId, kategoriId) {
        ...
        return $(`#${tableId}`).DataTable({
            ...
            ajax: {
                url: `{{ site_url('internal_api/produk-hukum') }}?filter[kategori]=${kategoriId}`,
                method: 'GET',
                data: row => {
                    drawCounter++;
                    return {
    ...
    $('#tabelInventaris').DataTable({
        ...
        ajax: {
            url: `{{ site_url('internal_api/buku-inventaris-kekayaan') }}`,
            method: 'GET'
        },
        columnDefs: [{ targets: '_all', className: 'text-nowrap' }],
        columns: [
    ...
    $('#tabelTanah').DataTable({
        ...
        ajax: {
            url: `{{ site_url('internal_api/buku-tanah-kas-desa') }}`,
            method: 'GET'
        },
        columnDefs: [{ targets: '_all', className: 'text-nowrap' }],
        columns: [
