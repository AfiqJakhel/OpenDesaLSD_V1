                            ...
                            <div class="btn-group visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">
                                ...
                                <ul class="dropdown-menu">
                                    @foreach ($list_kategori as $data)
                                        <li><a href="{{ ci_route('web.form', $data['id']) }}">{{ $data['kategori'] }}</a></li>
                                        @foreach ($data['children'] as $submenu)
                                            <li><a href="{{ ci_route('web.form', $submenu['id']) }}">&emsp;{{ $submenu['kategori'] }}</a></li>
                                        @endforeach
                                    @endforeach
                                    <li role="separator" class="divider"></li>
                                    <li><a href="{{ ci_route('web.form', 0) }}">[Tidak Berkategori]</a></li>
                                </ul>
                            </div>
                        @else
