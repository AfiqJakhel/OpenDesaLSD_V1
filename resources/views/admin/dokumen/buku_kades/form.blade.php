...
@section('breadcrumb')
    <li><a href="{{ site_url('dokumen_sekretariat/perdes/' . $kat) }}"> Daftar
            {{ $kat_nama }}
        </a></li>
...
@section('content')
    ...
    <div class="box box-info">
        ...
        <div class="box-header with-border">
            <x-kembali-button judul="Kembali ke Daftar {{ $kat_nama }} Di {{ ucwords(setting('sebutan_desa')) }}" url="dokumen_sekretariat/perdes/{{ $kat }}" />
        </div>
