...
class Penduduk extends Admin_Controller
{
    ...
    private function sumberData()
    {
        ...
        return PendudukModel::with(['log_latest'])
            ...
            ->selectRaw('(SELECT no_kk FROM tweb_keluarga WHERE tweb_keluarga.id = tweb_penduduk.id_kk) as order_no_kk')
            ...
            ->orderBy('order_no_kk', 'ASC')
            ->orderBy('tweb_penduduk.kk_level', 'ASC')
            ->orderBy(DB::raw("CASE
