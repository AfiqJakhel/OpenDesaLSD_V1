 ...
 */
define('VERSI_DATABASE', '2026030101');
...
if (!function_exists('menu_slug')) {
    ...
    function menu_slug($url)
    {
        ...
        // Konversi underscore ke dash untuk semua URL (kecuali yang sudah diproses khusus di atas)
        // Ini memastikan kompatibilitas dengan route yang menggunakan dash
