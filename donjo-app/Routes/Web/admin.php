...
// Lembaga [Desa] — route khusus, TANPA root path '/' karena
// GET /lembaga sudah menjadi milik public route (fweb\LembagaDesa).
// Admin mengakses lembaga CRUD via /lembaga/index
Route::group('lembaga', static function (): void {
    Route::get('/apipendudukkelompok', 'Lembaga@apipendudukkelompok')->name('lembaga.apipendudukkelompok');
    ...
    Route::match(['GET', 'POST'], '/index', 'Lembaga@index')->name('lembaga.index');
    Route::match(['GET', 'POST'], '/index/{p?}/{o?}', 'Lembaga@index');
    Route::match(['GET', 'POST'], '/index/{p?}', 'Lembaga@index');
    // CATATAN: Root path '/' sengaja TIDAK didaftarkan di sini.
    // GET /lembaga dimiliki oleh public route (fweb\LembagaDesa@index).
    // Admin menggunakan /lembaga/index untuk akses CRUD.
});

Route::group('lembaga_master', static function (): void {
    Route::get('/', 'Lembaga_master@index')->name('lembaga_master.index');
    Route::get('/datatables', 'Lembaga_master@datatables')->name('lembaga_master.datatables');
    ...
    Route::post('/delete_all/{id_kelompok?}', 'Lembaga_master@delete_all')->name('lembaga_master.delete_all');
});
...
// Kelompok — route tetap menggunakan root path karena tidak konflik dengan public
foreach (['kelompok' => 'Kelompok'] as $key => $value) {
