...
Route::group('', ['namespace' => 'fweb'], static function (): void {
    ...
    // Halaman Daftar Berita (terpisah dari landing page)
    Route::get('berita', 'Artikel@berita')->name('web.berita.index');

    // Arsip Artikel
    Route::get('arsip', 'Arsip@index');

    // Kesehatan
    Route::get('data-kesehatan', 'Kesehatan@index')->name('fweb.kesehatan.index');
    ...
    // Lembaga - Halaman Publik
    Route::get('/lembaga', 'LembagaDesa@index')->name('web.lembaga.index');
    // Lembaga - Detail (untuk admin/internal)
    ...
    Route::get('pemerintah/tugas-fungsi', 'Pemerintah@tugas_fungsi')->name('web.pemerintah.tugas-fungsi');
    Route::get('pemerintah/regulasi', 'Pemerintah@regulasi')->name('web.pemerintah.regulasi');
    Route::get('pemerintah/transparansi', 'Pemerintah@transparansi')->name('web.pemerintah.transparansi');

    // Profil Desa
    Route::get('profil_desa', 'Profil_desa@index')->name('web.profil_desa.index');

    // SOTK
    Route::get('struktur-organisasi-dan-tata-kerja', 'Sotk@index')->name('web.sotk.index');
    Route::get('sotk', 'Sotk@index')->name('web.sotk.short');
    ...
    // Agenda
    Route::get('agenda', 'Agenda@index')->name('web.agenda.index');
